		...
		*/
		...
		// --- Actualizar ---
				...
				*/
				...
				+" Descripción: "+buscarpro.getDescripcl3());
				*/
		...
		/*
				...
				System.out.println("Código: "+listar.getIdproductocl3()+ " Nombre: "+listar.getNombrecl3()
				+" Precio: "+listar.getPreciocompracl3()+" Precio compra: "+listar.getPrecioventacl3()
				+" Estado: "+listar.getEstadocl3()+" Descripción: "+listar.getDescripcl3());
